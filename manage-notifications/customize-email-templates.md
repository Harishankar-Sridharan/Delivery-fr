...
Dans Nomadia Delivery, les modèles de notification personnalisés permettent aux planificateurs de personnaliser la communication avec les clients finaux en fonction de paramètres de mission tels que le type de client ou la valeur du colis. Cette fonctionnalité améliore la transparence opérationnelle et renforce la satisfaction client en garantissant l’envoi de messages pertinents et en temps voulu.

Modèles par défaut

Pour simplifier l’intégration, Nomadia Delivery propose une collection de modèles par défaut préconfigurés pour les e-mails et les SMS :

* Ces modèles sont activés par défaut.
