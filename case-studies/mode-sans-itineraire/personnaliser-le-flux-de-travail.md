...
* Autorisations administratives pour modifier les tables système.
...
* **Bouton de proximité** : Vérifiez si un livreur se trouve à l'emplacement prévu en activant **Oui** ou **Non**.
* **Définition de profil** : Restreignez des changements de statut spécifiques aux rôles autorisés, tels qu'un **Utilisateur Dispatch**.

**Comment faire : Personnaliser un flux de travail de mission**

1. Sélectionnez un statut de départ dans la grille du flux de travail, par exemple **Créé**.
...
4. Configurez la transition suivante, par exemple en autorisant un **Utilisateur Dispatch** à scanner une mission et la passer à **Livré**.
...
* ⚠️ **Modifications non enregistrées** : Cliquez toujours sur le bouton Enregistrer après avoir effectué des ajustements pour vous assurer que les modifications du flux de travail sont sauvegardées.
