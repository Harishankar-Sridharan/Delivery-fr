...
Utilisez les étapes suivantes pour enregistrer un sous-traitant

1. Ouvrez l’application Nomadia Delivery et accédez au module Sous-traitants. (Assurez-vous que l’utilisateur dispose des droits nécessaires pour créer et modifier des sous-traitants.)
2. Cliquez sur le menu Actions et sélectionnez le bouton Ajouter.

<figure><img src="../.gitbook/assets/msedge_HgD5O3S8nd.png" alt=""><figcaption></figcaption></figure>

3. Lors de l’ajout d’un sous-traitant, les champs suivants sont obligatoires :

* Identifiant
* Nom du sous-traitant
* Adresse du sous-traitant
* Types de mission qu’ils peuvent gérer
* Utilisateurs web attribués
* Utilisateurs mobiles attribués
* Profils
* Agence
