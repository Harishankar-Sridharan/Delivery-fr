# Affectation des missions au sous-traitant

Le nouvel utilisateur du sous-traitant peut désormais accéder à l’application et effectuer ses tâches, telles qu’importer des missions, planifier et exécuter des missions. Utilisez les étapes suivantes pour attribuer des missions aux sous-traitants. Les transporteurs peuvent attribuer des zones géographiques prédéfinies, basées sur les codes postaux, aux sous-traitants. Cette attribution ciblée des missions garantit que chaque sous-traitant est responsable de zones spécifiques, ce qui améliore l’efficacité des opérations logistiques. En quelques clics, les transporteurs peuvent déléguer des missions spécifiques aux sous-traitants, réduisant ainsi la coordination manuelle et simplifiant l’ensemble du processus d’attribution.
...
<figure><img src="../.gitbook/assets/msedge_WW59GcP58v.png" alt=""><figcaption></figcaption></figure>

4. Les missions sélectionnées seront désormais attribuées au sous-traitant choisi.

<figure><img src="../.gitbook/assets/msedge_6e4Bz4Tm2D.png" alt=""><figcaption></figcaption></figure>

Utilisez les étapes suivantes pour filtrer les missions attribuées aux sous-traitants

1. Ouvrez l’application Nomadia Delivery et accédez à l’onglet Missions.
2. Par défaut, les transporteurs peuvent voir toutes les missions créées dans le système de gestion des livraisons. Pour filtrer les missions attribuées à des sous-traitants spécifiques, cliquez sur l’option Filtre préalable dans l’onglet des missions.
